...
struct Command
{
     ...
     */
    Command(const char* _command, void (*_callback)(char*)): command(_command), callback(_callback) {}
};
...
public:
     ...
     * @return True on success, false otherwise.
     */
    bool add(const char* command, void (*callback)(char*));
